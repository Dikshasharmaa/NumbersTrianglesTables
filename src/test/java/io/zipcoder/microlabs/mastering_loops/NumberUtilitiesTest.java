...
public class NumberUtilitiesTest {
    ...
    public void testGetRange1A() {
        ...
        int stop = 10;// changed it from 11 because eit was wrong
    ...
    public void testGetRange3B() {
        // : Given
        String expected = "100101102103104105106107108109";//chnged the test 102 was missing
        int start = 100;
        int stop = 110;
    ...
    public void testGetEvenNumbers() {
        // : Given
        String expected = "681012141618";// changed these tests
        int start = 5;
        int stop = 20;
    ...
    public void testGetOddNumbers() {
        // : Given
        String expected = "5791113151719";//changed these tests
        int start = 5;
        int stop = 20;
        int step = 5;
